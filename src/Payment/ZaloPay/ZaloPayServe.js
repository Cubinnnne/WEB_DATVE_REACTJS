...
const config = {
  ...
  callback_url:
    // "http://192.168.82.131:3000/api/zalopay/callback"
    "https://1c65-113-172-67-60.ngrok-free.app/api/zalopay/callback", //ngrok http 3000 --host-header=localhost
};
...
app.post('/api/zalopay/callback', (req, res) => {
    let result = {};
    console.log("Dữ liệu hủy thanh toán nhận được:", req.body);
    try {
