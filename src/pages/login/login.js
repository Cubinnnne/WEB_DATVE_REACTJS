...
=======
      ...
      window.recaptchaVerifier
        .render()
        .catch((error) => console.error("Lỗi reCAPTCHA:", error));
>>>>>>> b08c117 (Cập nhật dự án lên GitHub)
    }
  }
...
=======
        ...
        <div className="services">
          <div className="service-item">
            <img src={ketnoi1} alt="Xe Hợp Đồng" />
          </div>
          <div className="service-item">
            <img src={ketnoi2} alt="Mua vé Phương Trang" />
          </div>
          <div className="service-item">
            <img src={ketnoi3} alt="Giao Hàng" />
          </div>
          <div className="service-item">
            <img src={ketnoi4} alt="Xe Buýt" />
          </div>
>>>>>>> b08c117 (Cập nhật dự án lên GitHub)
        </div>
      </div>
