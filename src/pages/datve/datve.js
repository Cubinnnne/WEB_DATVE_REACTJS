      ...
      <div className="thong-tin-luot-di">
        ...
        <ul>
          <li>
            ...
            {selectedTrip ? `${selectedTrip.from} - ${selectedTrip.to}` : "N/A"}
          </li>
          <li>
            <strong>Thời gian xuất bến:</strong>{" "}
            {selectedTrip ? `${selectedTrip.timedi}` : "N/A"}
          </li>
          <li>
            <strong>Số lượng ghế:</strong> {selectedSeats.length}
          </li>
          <li>
            <strong>Số ghế:</strong> {selectedSeats.join(", ")}
          </li>
        </ul>
        ...
        <div className="pickup">
          <p className="pickdrop">Điểm đón</p>
          <p className="diadiem">
            {selectedTrip?.from ? `Bến xe ${selectedTrip.from}` : "N/A"}
          </p>
        </div>
        <div className="dropoff">
          <p className="pickdrop">Điểm trả</p>
          <p className="diadiem">
            {selectedTrip?.to ? `Bến xe ${selectedTrip.to}` : "N/A"}
          </p>
        </div>
        <div className="info">
          <p>
          ...
          <div className="payment-section">
            <div className="payment-method">
              ...
              <span className="price">
                {selectedSeats.length > 0
                  ? `${formatPriceToString(
                      parsePriceToInt(selectedTrip?.price) *
