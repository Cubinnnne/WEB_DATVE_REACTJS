...
function Body() {
  ...
  const [selectedTime, setSelectedTime] = useState(""); // State lưu giờ đã chọn
<<<<<<< HEAD
  const [selectedSeatType, setSelectedSeatType] = useState(''); // Thêm state để lưu loại ghế đã chọn
=======
  const [selectedSeatType, setSelectedSeatType] = useState(""); // Thêm state để lưu loại ghế đã chọn
>>>>>>> b08c117 (Cập nhật dự án lên GitHub)
...
<<<<<<< HEAD
    const autoFilteredTrips = Trips.filter(trip => {
      const [tripHours, tripMinutes] = trip.timedi.split(":").map(Number);

      // Lọc theo giờ đi
      const isWithinSelectedTime = selectedTime === "" ||
          (selectedTime === "00:00 - 06:00" && tripHours >= 0 && tripHours < 6) ||
          (selectedTime === "06:00 - 12:00" && tripHours >= 6 && tripHours < 12) ||
          (selectedTime === "12:00 - 18:00" && tripHours >= 12 && tripHours < 18) ||
          (selectedTime === "18:00 - 24:00" && tripHours >= 18 && tripHours < 24);

      // Lọc theo loại ghế
      const isMatchingSeatType = selectedSeatType === "" || trip.type === selectedSeatType;
=======
    const autoFilteredTrips = Trips.filter((trip) => {
      const [tripHours, tripMinutes] = trip.timedi.split(":").map(Number);

      // Lọc theo giờ đi
      const isWithinSelectedTime =
        selectedTime === "" ||
        (selectedTime === "00:00 - 06:00" && tripHours >= 0 && tripHours < 6) ||
        (selectedTime === "06:00 - 12:00" &&
          tripHours >= 6 &&
          tripHours < 12) ||
        (selectedTime === "12:00 - 18:00" &&
          tripHours >= 12 &&
          tripHours < 18) ||
        (selectedTime === "18:00 - 24:00" && tripHours >= 18 && tripHours < 24);

      // Lọc theo loại ghế
      const isMatchingSeatType =
        selectedSeatType === "" || trip.type === selectedSeatType;
>>>>>>> b08c117 (Cập nhật dự án lên GitHub)

      // Lọc theo ngày và giờ đi (nếu là ngày hiện tại)
      if (trip.date > currentDate) {
        return isWithinSelectedTime && isMatchingSeatType;
      } else if (trip.date === currentDate) {
        return (
<<<<<<< HEAD
            isWithinSelectedTime &&
            isMatchingSeatType &&
...
>>>>>>> b08c117 (Cập nhật dự án lên GitHub)
    ...
    setFilteredTrips(autoFilteredTrips);
  }, [selectedTime, selectedSeatType, Trips]); // Theo dõi các trạng thái liên quan
  const handleSearch = () => {
    const now = new Date();
    const currentDate = now.toISOString().split("T")[0];
    const currentHours = now.getHours();
...
>>>>>>> b08c117 (Cập nhật dự án lên GitHub)
    ...
    setTrips(matchedTrips); // Lưu danh sách vào `Trips`
    setFilteredTrips(matchedTrips); // Hiển thị kết quả ban đầu
...
<<<<<<< HEAD
    setSelectedTime("");       // Bỏ chọn khung giờ
    setSelectedSeatType("");   // Bỏ chọn loại ghế
    setFilteredTrips(Trips);   // Hiển thị lại tất cả chuyến đi
=======
    setSelectedTime(""); // Bỏ chọn khung giờ
    setSelectedSeatType(""); // Bỏ chọn loại ghế
    setFilteredTrips(Trips); // Hiển thị lại tất cả chuyến đi
            ...
            <div className='show-ticket-section'>
              <div className='loc-section'>
                <div className='loc-section-title'>
                  <p>BỘ LỌC TÌM KIẾM</p>
                  <p
                      className='cancel-loc'
                      onClick={handleClearFilters}
                      style={{ cursor: "pointer", color: "red" }} // Thêm style để hiển thị rõ là nút
                  >
                    Bỏ lọc
                  </p>
                </div>
                ...
                <div className='loc-section-content'>
                  ...
                  <div className='check-loc'>
                    <input
                        ...
                        name="time"
                        value="00:00 - 06:00"
                        checked={selectedTime === "00:00 - 06:00"}
                        onChange={() => setSelectedTime("00:00 - 06:00")}
                    />
                  ...
                  <div className='check-loc'>
                    <input
                        ...
                        name="time"
                        value="06:00 - 12:00"
                        checked={selectedTime === "06:00 - 12:00"}
                        onChange={() => setSelectedTime("06:00 - 12:00")}
                    />
                  ...
                  <div className='check-loc'>
                    <input
                        ...
                        name="time"
                        value="12:00 - 18:00"
                        checked={selectedTime === "12:00 - 18:00"}
                        onChange={() => setSelectedTime("12:00 - 18:00")}
                    />
                  ...
                  <div className='check-loc'>
                    <input
                        ...
                        name="time"
                        value="18:00 - 24:00"
                        checked={selectedTime === "18:00 - 24:00"}
                        onChange={() => setSelectedTime("18:00 - 24:00")}
                    />
                  ...
                  <div>
                    ...
                    <div className='loai-ghe'>
                      <button
                          type="button"
                          onClick={() => setSelectedSeatType('Ghế')}
                          className={selectedSeatType === 'Ghế' ? 'active' : ''}
                          style={{ color: selectedSeatType === 'Ghế' ? 'orange' : 'black' }}
                      >
                        Ghế
                      </button>
                      <button
                          type="button"
                          onClick={() => setSelectedSeatType('Giường')}
                          className={selectedSeatType === 'Giường' ? 'active' : ''}
                          style={{ color: selectedSeatType === 'Giường' ? 'orange' : 'black' }}
                      >
                        Giường
                      </button>
                      <button
                          type="button"
                          onClick={() => setSelectedSeatType('Limousine')}
                          className={selectedSeatType === 'Limousine' ? 'active' : ''}
                          style={{ color: selectedSeatType === 'Limousine' ? 'orange' : 'black' }}
                      >
                        Limousine
                      </button>
                    </div>
  ...
  return (
    <div>
              ...
              <div>
                ...
                <div className="loai-ghe">
                  <button
                    ...
                    className={selectedSeatType === "Ghế" ? "active" : ""}
                    style={{
                      color: selectedSeatType === "Ghế" ? "orange" : "black",
                    }}
                  >
                    Ghế
                  </button>
                  <button
                    ...
                    className={selectedSeatType === "Giường" ? "active" : ""}
                    style={{
                      color: selectedSeatType === "Giường" ? "orange" : "black",
                    }}
                  >
                    Giường
                  </button>
                  <button
                    ...
                    style={{
                      color:
                        selectedSeatType === "Limousine" ? "orange" : "black",
                    }}
                  >
                    Limousine
                  </button>
              ...
              <div className="route-card-body">
                ...
                <ul>
                  <li>
                    Đà Lạt
                    <br />
                    <span>305km - 8 giờ - 01/10/2024</span>{" "}
                    <span className="price">290.000đ</span>
                  </li>
                  <li>
                    Cần Thơ
                    <br />
                    <span>166km - 3 giờ 12 phút - 01/10/2024</span>{" "}
                    <span className="price">165.000đ</span>
                  </li>
                  <li>
                    Long Xuyên
                    <br />
                    <span>203km - 5 giờ - 01/10/2024</span>{" "}
                    <span className="price">190.000đ</span>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="route-card-body">
                ...
                <ul>
                  <li>
                    TP. Hồ Chí Minh
                    <br />
                    <span>310km - 8 giờ - 01/10/2024</span>{" "}
                    <span className="price">290.000đ</span>
                  </li>
                  <li>
                    Đà Nẵng
                    <br />
                    <span>757km - 17 giờ - 01/10/2024</span>{" "}
                    <span className="price">410.000đ</span>
                  </li>
                  <li>
                    Cần Thơ
                    <br />
                    <span>457km - 11 giờ - 01/10/2024</span>{" "}
                    <span className="price">435.000đ</span>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="route-card-body">
                ...
                <ul>
                  <li>
                    Đà Lạt
                    <br />
                    <span>666km - 17 giờ - 01/10/2024</span>{" "}
                    <span className="price">410.000đ</span>
                  </li>
                  <li>
                    BX An Sương
                    <br />
                    <span>966km - 20 giờ - 01/10/2024</span>{" "}
                    <span className="price">410.000đ</span>
                  </li>
                  <li>
                    Nha Trang
                    <br />
                    <span>528km - 9 giờ 25 phút - 01/10/2024</span>{" "}
          ...
          <div className="statistics-items">
            ...
            <div className="stat-item">
              ...
              <div className="stat-text">
                <h3>Hơn 1,000</h3>
                <p>
                  Phương Trang phục vụ hơn 1,000 chuyến xe đường dài và liên
                  tỉnh mỗi ngày
                </p>
              </div>
            </div>
      ...
      <div className="news-section">
        <div className="news-header">
          <h2>TIN TỨC MỚI</h2>
          <a href="/all-news" className="view-all">
            Xem tất cả
          </a>
        </div>
        <Swiper
        ...
        >
          <SwiperSlide>
            <div className="news-card">
              ...
              <div className="news-details">
                <h3>
                  PHƯƠNG TRANG - FUTA BUS LINES THÔNG BÁO THAY ĐỔI SỐ TỔNG ĐÀI
                  ĐẶT VÉ KHU VỰC NAM...
                </h3>
                <p>28/09/2024</p>
                <a href="/news-detail/1" className="news-link">
                  Chi tiết &gt;
                </a>
              </div>
            </div>
          ...
          <SwiperSlide>
            <div className="news-card">
              ...
              <div className="news-details">
                <h3>
                  PHƯƠNG TRANG - FUTA BUS LINES KHAI TRƯƠNG VĂN PHÒNG HÒN ĐẤT -
                  KIÊN GIANG
                </h3>
                <p>27/09/2024</p>
                <a href="/news-detail/2" className="news-link">
                  Chi tiết &gt;
                </a>
              </div>
            </div>
          ...
          <SwiperSlide>
            <div className="news-card">
              ...
              <div className="news-details">
                <h3>
                  PHƯƠNG TRANG – FUTA BUS LINES KHAI TRƯƠNG VĂN PHÒNG KON TUM
                </h3>
                <p>26/09/2024</p>
                <a href="/news-detail/3" className="news-link">
                  Chi tiết &gt;
                </a>
              </div>
            </div>
